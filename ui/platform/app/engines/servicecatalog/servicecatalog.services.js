...
.factory('serviceCatalogServices', function($q, $http,httpPayload) {
  ...
  var _configureDocMetadata = function(reqObj) {
    var req = {
      method: 'POST',
      url: '/api/serviceCatalog/configure/',
      headers:httpPayload.getHeader(),
      data: reqObj.data
    };
    var deferred = $q.defer();
  ...
  var _enableDocMetadata = function(reqObj) {
    var req = {
      method: 'POST',
      url: '/api/serviceCatalog/configure/',
      headers:httpPayload.getHeader(),
    ...
    var serviceCatalogServices = {
        getInsights:_getInsights,
        configureInsight:_configureInsight,
        testInsight:_testInsight,

        configureDocMetadata:_configureDocMetadata,
        enableDocMetadata:_enableDocMetadata
    };

    return serviceCatalogServices;
});
