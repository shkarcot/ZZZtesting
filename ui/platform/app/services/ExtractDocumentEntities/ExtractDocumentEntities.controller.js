(function() {
	...
	module.exports = ['$state','$rootScope','$scope','ExtractDocumentEntitiesServices','ngDialog',
	function($state,$rootScope,$scope,ExtractDocumentEntitiesServices,ngDialog) {
	    var vm = this;
        ...
        $scope.testDocId=function(val){
            if(val!=""){
                ...
                var obj={"request_type":$scope.servicesObj.request_trigger,"doc_id": val};
                 ExtractDocumentEntitiesServices.testExtractDocumentEntities({'data':obj,'sess_id':vm.sess_id}).then(function(data){
