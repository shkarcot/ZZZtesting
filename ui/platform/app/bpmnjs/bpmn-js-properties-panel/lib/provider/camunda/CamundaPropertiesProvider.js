...
function createThresholdTabGroups(element, bpmnFactory, elementRegistry, elementTemplates, translate) {

  // Create a group called "Threshold".
  var thresholdGroup = {
    id: 'serviceTaskThreshold',
    label: translate('Threshold'),
    entries: []
  };

  //nameProps(thresholdGroup, element, translate);
  idProps(thresholdGroup, element, translate);
  variableMapping(thresholdGroup, element, bpmnFactory, translate);

  var groups = [];
  groups.push(thresholdGroup);
...
function CamundaPropertiesProvider(eventBus, bpmnFactory, elementRegistry, elementTemplates, translate) {
  ...
  this.getTabs = function(element) {
    ...
    var thresholdTab = {
      ...
      groups: createThresholdTabGroups(element, bpmnFactory,elementRegistry, elementTemplates, translate)
    };
