angular.module("console.tagsAutocomplete",[])
.directive('tagManager', function() {
    return {
        ...
        template:
            '<div class="tags">' +
      			'<div ng-repeat="(idx, tag) in tags" class="tag">{$ tag $} <a class="close" href ng-click="remove(idx)">×</a></div>' +
            '</div>' +
            '<div class="input-group col-lg-12 col-sm-12 col-xs-12 col-md-12"><input type="text" class="form-control" placeholder="Add marker" ng-model="newValue" /> '
            ,
